...
public class PanelListaEstudiantes extends JPanel {
    ...
    public PanelListaEstudiantes(ActionListener listener) {
        ...
        String[] columnas = {"Nombre", "Edad", "Carrera", "Colegio", "Género"};
    ...
    public void actualizarTabla(List<Estudiante> estudiantes) {
        ...
        for (Estudiante estudiante : estudiantes) {
            Object[] fila = {estudiante.getNombre(), estudiante.getEdad(), estudiante.getCarrera(), estudiante.getColegio(), estudiante.getGenero()};
